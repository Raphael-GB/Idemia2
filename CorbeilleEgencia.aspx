<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpage.Master" CodeBehind="CorbeilleEgencia.aspx.vb" Inherits="WORKFLOW_FACTURE.CorbeilleEGENCIA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading panel-heading-custom">
                        <i class="fa fa-files-o fa-fw"></i>&nbsp;Factures Engencia
                    </div>
    ...
    <form id="form-extraction" method="post" action="Handlers\ExtractionFactureEngencia.ashx">
    ...
    <script>
        $(document).ready(function () {
            ...
            var myTable = $('#dataTables-rejets').dataTable({
                ...
                "sAjaxSource": 'Handlers/JsonFactureEGENCIA.ashx?rejet=' + $("#<%=ddlRejet.ClientID%>").val()<%-- + '&statut=' + $("#<%=ddlStatutFacture.ClientID%>").val()--%>,
