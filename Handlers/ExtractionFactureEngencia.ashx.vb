...
Public Class ExtractionFactureEngencia
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If (Not context.Session("Utilisateur") Is Nothing) Then
            ...
            If (Not ((context.Request.Params("extIdStatutFacture") Is Nothing))) Then
                ...
                Dim liste_factures As List(Of Facture) = DBFunctions.getFacturesEgencia(current_user, "", liste_statuts, True, False, True, "", 0, "").ToList()
                Dim liste_alertes_facture As List(Of AlerteFacture) = DBFunctions.getAlertesFacture("", current_user, False, "")

                Dim ligne As String

                Dim nom_fichier As String = "EXTRACTION_EGENCIA_" & timestramp & ".csv"
                ...
                Using sw As New StreamWriter(ms, Encoding.UTF8)
                    ...
                    Dim entete As String = "ID FACTURE;CODE FOURNISSEUR;NOM FOURNISSEUR;NUM FACTURE;DATE FACTURE;ENTITE FACTURE;MONTANT TTC;DATE INSERTION;FLAG ALERTE;MOTIF ALERTE;EMETTEUR ALERTE"
                    ...
                    For Each fact As Facture In liste_factures
                        ...
                        ligne = fact.IDFacture.Replace(";", " ") & ";" & fact.CodeFournisseur.Replace(";", " ") & ";" & fact.NomFournisseur.Replace(";", " ") & ";" & fact.NumFacture.Replace(";", " ") & ";" & fact.DateFacture.Replace(";", " ") & ";" & fact.EntiteFacture.Replace(";", " ") & ";" & fact.MontantTTC.Replace(";", " ") & ";" & fact.DateInsertion.Replace(";", " ") & ";" & flag_alerte.Replace(";", " ") & ";" & motif_alerte.Replace(";", " ") & ";" & emetteur_alerte.Replace(";", " ")
