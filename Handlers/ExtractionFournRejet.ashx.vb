...
Public Class ExtractionFournRejet
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If (Not context.Session("Utilisateur") Is Nothing) Then
            ...
            If (Not ((context.Request.Params("extIdStatutFacture") Is Nothing) Or (context.Request.Params("extIdFiltre") Is Nothing))) Then
                ...
                Dim liste_factures As List(Of Facture) = DBFunctions.getFactures(current_user, id_filtre, liste_statuts, True, False, True, 5, 0, "")
                ...
                If id_statut_facture = "1" Then
                    nom_fichier = "EXTRACTION_FOURN_MUTLIPLE_" & timestramp & ".csv"
                Else
                    nom_fichier = "EXTRACTION_FOURN_INCONNU_" & timestramp & ".csv"
                End If
