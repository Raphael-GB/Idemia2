...
Public Class JsonArchives099PU
    ...
    Private Function getLignesFactures(p_user As Utilisateur, p_filtre As String, p_statut As String) As List(Of LigneFactureCorbeille)
        ...
        Try
            ...
            Dim liste_factures As List(Of Facture) = DBFunctions.getFactures(p_user, p_filtre, liste_statuts, True, True, False, "", 0, "", "099PU").ToList()
