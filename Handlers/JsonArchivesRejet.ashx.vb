...
Public Class JsonArchivesRejet
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If (Not context.Session("Utilisateur") Is Nothing) Then
            ...
            Dim lignes As List(Of LigneFactureCorbeille) = getLignesFactures(current_user, filtre, "7").FindAll(Function(x) x.Id.Contains(sSearch) _
                                                                                                                ...
                                                                                                                Or x.EmetteurAlerte.Contains(sSearch))
    ...
    Private Function getLignesFactures(p_user As Utilisateur, p_filtre As String, p_statut As String) As List(Of LigneFactureCorbeille)
        ...
        Try
            ...
            Else
                ...
                For Each item As ListItem In DBFunctions.getStatutsFactures("ARCHIVE")
                    liste_statuts.Add(item.Value)
                Next

            End If

            Dim liste_factures As List(Of Facture) = DBFunctions.getFactures(p_user, p_filtre, liste_statuts, True, False, True, "", 0, "", "HISTORIQUE").ToList()
