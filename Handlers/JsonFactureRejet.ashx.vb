...
Public Class JsonFactureRejet
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If (Not context.Session("Utilisateur") Is Nothing) Then
            ...
            Dim lignes As List(Of LigneFactureCorbeille) = getLignesFactures(current_user, rejet, statut).FindAll(Function(x) x.Site.Contains(sSearch) _
    ...
    Private Function getLignesFactures(p_user As Utilisateur, p_rejet As String, p_statut As String) As List(Of LigneFactureCorbeille)
        ...
        Try
            ...
            Dim liste_factures As List(Of Facture) = DBFunctions.getFactures(p_user, "", liste_statuts, True, False, True, p_rejet, 0, "").Where(Function(x) x.Rejet.Id <> "5" And x.Rejet.Id <> "6" And x.NomFournisseur <> "EGENCIA").ToList()
