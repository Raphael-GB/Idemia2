...
Public Class ExtractionHorsScopeATraiter
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If (Not context.Session("Utilisateur") Is Nothing) Then
            ...
            If (Not ((context.Request.Params("extIdStatutFacture") Is Nothing) Or (context.Request.Params("extIdFiltre") Is Nothing))) Then
                ...
                Dim liste_documentHorsScope As List(Of DocumentHorsScope) = DBFunctions.getListDocumentHorsScope(current_user, id_filtre).Where(Function(x) x.Statut.Id = "2").ToList()

                Dim ligne As String

                Dim nom_fichier As String = "EXTRACTION_DOCUMENTS_HORS_SCOPE_A_TRAITER" & timestramp & ".csv"

                Dim ms As New MemoryStream()

                Using sw As New StreamWriter(ms, Encoding.UTF8)

                    Dim entete As String = "ID DOCUMENT;SITE;TYPE DE DOCUMENT;ENTITE;DATE INSERTION"

                    sw.WriteLine(entete)

                    For Each document As DocumentHorsScope In liste_documentHorsScope

                        ligne = document.Id.Replace(";", " ") & ";" & document.Site2.Replace(";", " ") & ";" & document.Type.Replace(";", " ") & ";" & document.Site.Replace(";", " ") & ";" & document.DateInsertion.Replace(";", " ")
