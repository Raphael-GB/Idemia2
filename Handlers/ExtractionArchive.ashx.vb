...
Public Class ExtractionArchive
    Implements System.Web.IHttpHandler, System.Web.SessionState.IReadOnlySessionState

    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest

        Dim liste_factures As List(Of Facture) = New List(Of Facture)()
        ...
        If (Not context.Session("Utilisateur") Is Nothing) Then
            ...
            If (Not ((context.Request.Params("extIdStatutFacture") Is Nothing) Or (context.Request.Params("extIdFiltre") Is Nothing))) Then
                ...
                Dim type_archive As String = context.Request.Params("typeArchive").ToString()
                ...
                If type_archive = "HISTORIQUE" Then
                    liste_factures = DBFunctions.getFactures(current_user, id_filtre, liste_statuts, True, False, True, "", 0, "", type_archive).ToList()
                Else
                    liste_factures = DBFunctions.getFactures(current_user, id_filtre, liste_statuts, True, True, False, "", 0, "", type_archive).ToList()
                End If
                ...
                Dim nom_fichier As String = "EXTRACTION_ARCHIVE_" & type_archive & "-" & timestramp & ".csv"
