...
Public Class JsonHorsScope
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If (Not context.Session("Utilisateur") Is Nothing) Then
            ...
            Dim lignes As List(Of DocumentHorsScope) = DBFunctions.getListDocumentHorsScope(current_user, filtre).Where(Function(x) x.Statut.Id = "2").ToList() _
                                                                                                                 .FindAll(Function(x) x.Id.Contains(sSearch) _
                                                                                                                                      Or x.Type.Contains(sSearch) _
                                                                                                                                      Or x.Site.Contains(sSearch) _
                                                                                                                                      Or x.DateInsertion.Contains(sSearch) _
                                                                                                                                      Or x.Site2.Contains(sSearch) _
