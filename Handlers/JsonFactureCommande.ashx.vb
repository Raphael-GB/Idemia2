...
Public Class JsonFactureCommande
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If (Not context.Session("Utilisateur") Is Nothing) Then
            ...
            Dim lignes As List(Of LigneFactureCorbeille) = getLignesFactures(current_user, filtre, statut).FindAll(Function(x) x.Id.Contains(sSearch) _
    ...
    Private Function getLignesFactures(p_user As Utilisateur, p_filtre As String, p_statut As String) As List(Of LigneFactureCorbeille)
        ...
        Try
            ...
            Dim liste_factures As List(Of Facture) = DBFunctions.getFactures(p_user, p_filtre, liste_statuts, True, False, False, "", 0, "", "099PU").ToList()
