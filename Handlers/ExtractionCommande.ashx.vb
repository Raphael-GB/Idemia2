...
Public Class ExtractionCommande
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If (Not context.Session("Utilisateur") Is Nothing) Then
            ...
            If (Not ((context.Request.Params("extIdStatutFacture") Is Nothing) Or (context.Request.Params("extIdFiltre") Is Nothing))) Then
                ...
                Dim liste_factures As List(Of Facture) = DBFunctions.getFactures(current_user, id_filtre, liste_statuts, True, True, False, "", 0, "").Where(Function(x) Regex.IsMatch(x.NumCommande, "99PU\d{8}")).ToList()
                Dim liste_alertes_facture As List(Of AlerteFacture) = DBFunctions.getAlertesFacture("", current_user, False, "")

                Dim ligne As String

                Dim nom_fichier As String = "EXTRACTION_COMMANDE_099PU_" & timestramp & ".csv"
