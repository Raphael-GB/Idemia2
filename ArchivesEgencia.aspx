<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpage.Master" CodeBehind="ArchivesEgencia.aspx.vb" Inherits="WORKFLOW_FACTURE.ArchivesEgencia" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var myTable = $('#dataTables-archives').dataTable({
                ...
                "sAjaxSource": 'Handlers/JsonArchivesEgencia.ashx?filtre=' + $("#<%=ddlFiltres.ClientID%>").val() <%--+ '&statut=' + $("#<%=ddlStatutFacture.ClientID%>").val()--%>,
