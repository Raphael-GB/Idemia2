<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpage.Master" CodeBehind="CorbeilleFournInconnu.aspx.vb" Inherits="WORKFLOW_FACTURE.CorbeilleFournInconnu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading panel-heading-custom">
                        <i class="fa fa-files-o fa-fw"></i>&nbsp;Factures "Fournisseur inconnu"
                    </div>
    ...
    <script>
        ...
        $("#btnExtraction").on("click", function () {
            ...
            //$("#extIdStatutFacture").val($("#dlStatutFacture.ClientID").val());
            ...
            var myTable = $('#dataTables-a-traiter').dataTable({
                ...
                "sAjaxSource": 'Handlers/JsonFactureFournInconnu.ashx?filtre=' + $("#<%=ddlFiltres.ClientID%>").val() <%--+ '&statut=' + $("#<%=ddlStatutFacture.ClientID%>").val()--%>,
