<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpage.Master" CodeBehind="ArchivesHorsScope.aspx.vb" Inherits="WORKFLOW_FACTURE.ArchivesHorsScope" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading panel-heading-custom">
                        <i class="fa fa-files-o fa-fw"></i>&nbsp;Archives Hors-Scope
                    </div>
    ...
    <form id="form-extraction" method="post" action="Handlers\ExtractionHSArchive.ashx">
