<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpage.Master" CodeBehind="ArchivesRejet.aspx.vb" Inherits="WORKFLOW_FACTURE.ArchivesRejet" %>
    ...
    <script>
        ...
        $("#btnExtraction").on("click", function () {
            ...
            var myTable = $('#dataTables-archives').dataTable({
                ...
                "sAjaxSource": 'Handlers/JsonArchivesRejet.ashx?filtre=' + $("#<%=ddlFiltres.ClientID%>").val(),
