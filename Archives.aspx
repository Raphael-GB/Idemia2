<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpage.Master" CodeBehind="Archives.aspx.vb" Inherits="WORKFLOW_FACTURE.Archives" %>
    ...
    <script>
        ...
        $("#btnExtraction").on("click", function () {
            ...
            var myTable = $('#dataTables-archives').dataTable({
                ...
                "sAjaxSource": 'Handlers/JsonArchives.ashx?filtre=' + $("#<%=ddlFiltres.ClientID%>").val(),
