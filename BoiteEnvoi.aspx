<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpage.Master" CodeBehind="BoiteEnvoi.aspx.vb" Inherits="WORKFLOW_FACTURE.BoiteEnvoi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table style="width: 100%" class="table table-striped table-bordered table-hover" id="dataTables-envoi">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Destinataires</th>
                ...
                <form id="form-nouveau-message" method="post" action="handlers/EnvoiMessage.ashx">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" style="margin-top: 15px;">
                            ...
                            <div class="col-lg-10">
                                <input id="txtSujet" name="txtSujet" type="text" class="form-control" value="" maxlength="200" /></div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var myTable = $('#dataTables-envoi').dataTable({
                "responsive": true,
                "fnDrawCallback": function () {
                    $('#dataTables-envoi tbody tr td:not(:last-child)').click(function () {
