<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpage.Master" CodeBehind="CorbeilleCommande.aspx.vb" Inherits="WORKFLOW_FACTURE.CorbeilleCommande" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading panel-heading-custom">
                        <i class="fa fa-files-o fa-fw"></i>&nbsp;Factures 099PU
                    </div>
    ...
    <form id="form-extraction" method="post" action="Handlers\ExtractionATraiter.ashx">
    ...
    <script>
        ...
        $("#btnExtraction").on("click", function () {          
            ...
            var myTable = $('#dataTables-a-traiter').dataTable({
                ...
                "pageLength": 100,
                "sAjaxSource": 'Handlers/JsonFactureCommande.ashx?filtre=' + $("#<%=ddlFiltres.ClientID%>").val() <%--+ '&statut=' + $("#<%=ddlStatutFacture.ClientID%>").val()--%>,
